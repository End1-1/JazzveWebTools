...
import 'package:jazzve_web/onlinestore/config.dart';
...
class AppWebSocket {
  ...
  static late final  AppWebSocket instance;
  ...
  void _connect() {
    ...
    try {
      ...
      sendMessage(jsonEncode({'command':'register_socket', 'socket_type':4, 'userid':0, 'database':'no'}), null);
    } catch (e) {
      _replyMessage({'errorCode':-10, 'errorMessage': e.toString()});
      _closeChannel();
      _setConnectionState(ConnectionStateType.error);
